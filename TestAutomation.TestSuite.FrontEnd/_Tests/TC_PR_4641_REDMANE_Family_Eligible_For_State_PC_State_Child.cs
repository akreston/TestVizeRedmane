...
{
    [TestClass]
    public class TC_PR_4641_REDMANE_Family_Eligible_For_State_PC_State_Child : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.State)]
        [TestCategory(Category.SmokeTest)]
        [DeploymentItem("TestData\\TC_PR_4641_REDMANE_Family_Eligible_For_State_PC_State_Child.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_4641_REDMANE_Family_Eligible_For_State_PC_State_Child.csv", "TC_PR_4641_REDMANE_Family_Eligible_For_State_PC_State_Child#csv", DataAccessMethod.Sequential)]

        public void TestCase_PR_4641_REDMANE_Family_Eligible_For_State_PC_State_Child()
        {
            ExecuteTest();
        }
