...
{
    [TestClass]
    public class TC_PR_3307_REDMANE_Siblings_Former_Foster_Care : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.MAGI)]
        [DeploymentItem("TestData\\TC_PR_3307_REDMANE_Siblings_Former_Foster_Care.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_3307_REDMANE_Siblings_Former_Foster_Care.csv", "TC_PR_3307_REDMANE_Siblings_Former_Foster_Care#csv", DataAccessMethod.Sequential)]
        public void TestCase_PR_3307_REDMANE_Siblings_Former_Foster_Care()
        {
            ExecuteTest();
        }
