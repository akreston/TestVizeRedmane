...
{
    [TestClass]
    public class TC_PR_3304_REDMANE_Not_In_Foster_Care_W_ADFAN_On_BD : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.MAGI)]
        [DeploymentItem("TestData\\TC_PR_3304_REDMANE_Not_In_Foster_Care_W_ADFAN_On_BD.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_3304_REDMANE_Not_In_Foster_Care_W_ADFAN_On_BD.csv", "TC_PR_3304_REDMANE_Not_In_Foster_Care_W_ADFAN_On_BD#csv", DataAccessMethod.Sequential)]
        public void TestCase_PR_3304_REDMANE_Not_In_Foster_Care_W_ADFAN_On_BD()
        {
            ExecuteTest();
        }
