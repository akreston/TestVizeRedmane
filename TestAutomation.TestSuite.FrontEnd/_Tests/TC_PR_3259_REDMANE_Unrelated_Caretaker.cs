...
{
    [TestClass]
    public class TC_PR_3259_REDMANE_Unrelated_Caretaker : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.MAGI)]
        [DeploymentItem("TestData\\TC_PR_3259_REDMANE_Unrelated_Caretaker.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_3259_REDMANE_Unrelated_Caretaker.csv", "TC_PR_3259_REDMANE_Unrelated_Caretaker#csv", DataAccessMethod.Sequential)]
        public void TestCase_PR_3259_REDMANE_Unrelated_Caretaker()
        {
            ExecuteTest();
        }
