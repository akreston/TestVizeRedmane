...
{
    [TestClass]
    public class TC_PR_3260_REDMANE_Grandparents_MAGI_Parent_MAGI_Child : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.MAGI)]
        [DeploymentItem("TestData\\TC_PR_3260_REDMANE_Grandparents_MAGI_Parent_MAGI_Child.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_3260_REDMANE_Grandparents_MAGI_Parent_MAGI_Child.csv", "TC_PR_3260_REDMANE_Grandparents_MAGI_Parent_MAGI_Child#csv", DataAccessMethod.Sequential)]
        public void TestCase_PR_3260_REDMANE_Grandparents_MAGI_Parent_MAGI_Child()
        {
            ExecuteTest();
        }
