...
{
    [TestClass]
    public class TC_PR_3242_REDMANE_3_Members_MAGI_Coverage : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.SmokeTest)]
        [TestCategory(Category.MAGI)]
        [DeploymentItem("TestData\\TC_PR_3242_REDMANE_3_Members_MAGI_Coverage.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_3242_REDMANE_3_Members_MAGI_Coverage.csv", "TC_PR_3242_REDMANE_3_Members_MAGI_Coverage#csv", DataAccessMethod.Sequential)]
        public void TestCase_PR_3242_REDMANE_3_Members_MAGI_Coverage()
        {
            ExecuteTest();
        }
