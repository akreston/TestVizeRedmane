...
{
    [TestClass]
    public class TC_PR_3246_REDMANE_Pregnant_Woman_Income : AutomationTestCase
    {
        [TestMethod]
        [TestCategory(Category.Regression)]
        [TestCategory(Category.MAGI)]
        [DeploymentItem("TestData\\TC_PR_3246_REDMANE_Pregnant_Woman_Income.csv")]
        [DataSource("Microsoft.VisualStudio.TestTools.DataSource.CSV", "TC_PR_3246_REDMANE_Pregnant_Woman_Income.csv", "TC_PR_3246_REDMANE_Pregnant_Woman_Income#csv", DataAccessMethod.Sequential)]
        public void TestCase_PR_3246_REDMANE_Pregnant_Woman_Income()
        {
            ExecuteTest();
        }
        ...
        protected override void ExecuteTest()
        {
            ...
            var relationshipData = ExcelFileServer.ReadExcelFileWithHeaders(testDataFileFullPath, "HouseholdMemberInfo");
